    ...
    return (
        <section className='bg-neutral-900 fixed top-0 bottom-0 right-0 left-0 bg-opacity-70 z-50'>
            <div className='bg-white w-full max-w-sm min-h-screen max-h-screen ml-auto'>
                ...
                <div className='min-h-[75vh] lg:min-h-[80vh] h-full max-h-[calc(100vh-150px)] bg-blue-50 p-2 flex flex-col gap-4 overflow-auto'>
                    {cartItems?.length ? (
                        ...
                        <div className='bg-white flex flex-col justify-center items-center h-full'>
                            <img src={imageEmpty} className='w-full h-full object-contain' />
                            <Link onClick={close} to={"/"} className='block bg-green-600 px-4 py-2 text-white rounded mt-2'>Shop Now</Link>
                        </div>
                    )}
                </div>
                ...
                {cartItems?.length > 0 && (
                    <div className='p-2'>
                        <div className='bg-green-700 text-neutral-100 px-4 font-bold text-base py-4 flex items-center gap-4 justify-between rounded'>
